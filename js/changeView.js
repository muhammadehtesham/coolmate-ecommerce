function handleResize() {
  ...
  if (width <= 574) {
    gridIcons[3].classList.add("changeBox-active");
  } else if (width <= 768) {
...
// for style check remove 
  ...
  productCard.forEach((productItem, index) => {
    ...
    if (iconId === 1) {
      productItem.classList.add("col-lg-3", "col-md-4", "col-sm-6", "col-6");
    } else if (iconId === 2) {
...
//   const viewGridFunction = (sectionId) => {
